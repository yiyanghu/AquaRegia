...
public class TestBitcoinAmount {
	...
	public void testBitcoinAmountBigInteger() {
		...
		assertEquals("0.007", s.coins().toPlainString());
		assertEquals("7", s.milliCoins().toPlainString());
		assertEquals("7000", s.microCoins().toPlainString());
	}
	...
	public void testBitcoinAmountBaseString() {
		...
		assertEquals("0.0000034", b.coins().toPlainString());
	...
	public void testCoins() {
		...
		BitcoinAmount s = new BitcoinAmount(new BigInteger(amount));
		assertEquals("0.085", s.coins().toPlainString());
	}
	...
	public void testMilliCoins() {
		...
		BitcoinAmount s = new BitcoinAmount(new BigInteger(amount));
		assertEquals("41", s.milliCoins().toPlainString());
	}
	...
	public void testMicroCoins() {
		String amount = "90";
		BitcoinAmount s = new BitcoinAmount(new BigInteger(amount));
		assertEquals("0.9", s.microCoins().toPlainString());
	}
	...
	public void testAdd() {
		...
		assertEquals("0.18", new BitcoinAmount(s1.add(s2)).coins().toPlainString());
	}
